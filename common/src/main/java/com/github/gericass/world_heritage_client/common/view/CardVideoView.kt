...
import com.github.gericass.world_heritage_client.common.databinding.CommonViewVideoBinding
...
class CardVideoView @JvmOverloads constructor(
    context: Context,
    attrs: AttributeSet? = null,
    defStyleAttr: Int = 0
) : LinearLayout(context, attrs, defStyleAttr) {

    private val binding: CommonViewVideoBinding
    ...
    init {
        ...
        binding = DataBindingUtil.inflate(inflater, R.layout.common_view_video, this, true)
    }
